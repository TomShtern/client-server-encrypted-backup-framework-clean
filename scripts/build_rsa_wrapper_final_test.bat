@echo off
echo Compiling final RSA wrapper test...
...
"%CL_PATH%" /EHsc /D_WIN32_WINNT=0x0601 /std:c++17 /I"client\include" /I"crypto++" /Fe:"tests\test_rsa_wrapper_final.exe" ^
tests\test_rsa_wrapper_final.cpp ^

...
class EnhancedServerGUI:
    ...
    def _create_enhanced_performance_chart(self, parent: tk.Widget) -> ModernCard:
        ...
        if not CHARTS_AVAILABLE or Figure is None:
            ...
            fallback_label = tk.Label(card.content_frame,
    ...
    def _create_system_tray(self) -> None:
        ...
        try:
            ...
            menu = (
                ...
                pystray.MenuItem('🚀 Start Server', self._start_server, enabled=not getattr(self.server, 'running', False)),
                pystray.MenuItem('⏹️ Stop Server', self._stop_server, enabled=getattr(self.server, 'running', False)),
                pystray.Menu.SEPARATOR,
    ...
    def _update_premium_performance_metrics(self) -> None:
        ...
        try:
            ...
            if hasattr(self, 'server_status_ring') and self.server_status_ring is not None:
    ...
    def _fade_in_content(self, content: tk.Widget) -> None:
        ...
        try:
            # Use dict-style access to avoid type checker issues
            if hasattr(content, 'configure'):
                content.configure({'bg': EnhancedTheme.PRIMARY_BG})
        except (tk.TclError, TypeError):
            # Some widgets don't support bg configuration
            pass
    ...
    def _on_db_table_select(self, event: tk.Event | None = None) -> None:
        ...
        try:
            ...
            # Cast parent to Widget type since master is always a Widget in practice

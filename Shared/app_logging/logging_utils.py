...
try:
    from Shared.app_logging.enhanced_output import Colors as EnhancedColors  # noqa: E402
    from Shared.app_logging.enhanced_output import Emojis as EnhancedEmojis  # noqa: E402
    from Shared.app_logging.enhanced_output import enhance_existing_logger  # noqa: E402
...
CODE_MAPS: dict[str, list[dict[str, str]]] = {
    "api": [
        ...
        {
            "code": "1xx",
            "text": "Informational (100 Continue, 101 Switching Protocols)",
            "emoji": Emojis.INFO,
            "level": "info",
        },
        {
    ...
    "backup": [
        ...
        {
            "code": "REQ_SEND_FILE (1028)",
            "text": "File transfer start",
            "emoji": Emojis.SUCCESS,
            "level": "success",
        },
        {
            "code": "RESP_REG_OK (1600)",
            "text": "Registration success",
            "emoji": Emojis.SUCCESS,
            "level": "success",
        },
        {
            "code": "RESP_FILE_CRC (1603)",

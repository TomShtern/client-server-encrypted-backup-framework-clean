...
class ControlPanelCard:
    ...
    def __init__(self, server_bridge: ServerBridge, page: ft.Page, show_notification: Callable, add_log_entry: Callable):
    ...
    async def start_server(self, e):
        ...
        try:
            ...
            if success:
                ...
                await self.show_notification("Server started successfully")

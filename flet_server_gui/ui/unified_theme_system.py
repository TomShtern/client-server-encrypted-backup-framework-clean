...
class MaterialDesignTokens:
    ...
    colors: Dict[ColorRole, str] = field(default_factory=lambda: {
        ...
        ColorRole.ON_INVERSE_SURFACE: "#FFFFFF",
...
LIGHT_COLOR_TOKENS: Dict[ColorRole, str] = {
    ColorRole.PRIMARY: ft.Colors.BLUE_600,
    ...
    ColorRole.SECONDARY: ft.Colors.GREEN_600,
    ...
    ColorRole.TERTIARY: ft.Colors.ORANGE_600,
    ...
    ColorRole.ERROR: ft.Colors.RED_600,
    ...
    ColorRole.ON_SURFACE: ft.Colors.BLACK,
    ...
    ColorRole.BACKGROUND: ft.Colors.WHITE,
    ColorRole.ON_BACKGROUND: ft.Colors.BLACK,
    
    ColorRole.SHADOW: "#000000",
    ColorRole.SCRIM: "#000000",
    
    ColorRole.INVERSE_SURFACE: "#333333",
    ColorRole.ON_INVERSE_SURFACE: ft.Colors.WHITE,
    
    ColorRole.INVERSE_PRIMARY: ft.Colors.BLUE_200,
}
...
DARK_COLOR_TOKENS: Dict[ColorRole, str] = {
    ...
    ColorRole.BACKGROUND: ft.Colors.GREY_900,
    ColorRole.ON_BACKGROUND: ft.Colors.WHITE,
    
    ColorRole.SHADOW: "#000000",
    ColorRole.SCRIM: "#000000",
    
    ColorRole.INVERSE_SURFACE: ft.Colors.WHITE,
    ColorRole.ON_INVERSE_SURFACE: "#333333",
    
    ColorRole.INVERSE_PRIMARY: ft.Colors.BLUE_600,
}
...
BUTTON_TOKENS: Dict[str, Union[int, str]] = {
    "height": 40,
    "min_width": 64,
...
CARD_TOKENS: Dict[str, Union[int, str]] = {
    "padding": SPACING_TOKENS["md"],
    "border_radius": BORDER_RADIUS_TOKENS["md"],
    "elevation": ELEVATION_TOKENS["level1"],
}

DIALOG_TOKENS: Dict[str, Union[int, str]] = {
    "padding": SPACING_TOKENS["lg"],
    "border_radius": BORDER_RADIUS_TOKENS["lg"],
    "elevation": ELEVATION_TOKENS["level5"],
    "max_width": 560,
}

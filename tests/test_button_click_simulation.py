#!/usr/bin/env python3
"""
Test script to simulate actual button clicks in the GUI
"""
...
def test_actual_button_click():
    """Test actual button click simulation"""
    print("Testing actual button click simulation...")
    ...
    try:
        ...
        print("[DEBUG] Button click simulation test completed")

    except Exception as e:
        print(f"[FAIL] Button click simulation test error: {e}")
        import traceback
        traceback.print_exc()

if __name__ == "__main__":
    test_actual_button_click()

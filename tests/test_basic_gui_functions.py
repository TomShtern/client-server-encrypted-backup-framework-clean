...
class TestResult:
    ...
    def __init__(self, name: str, success: bool, message: str = "", error: Exception | None = None):
        self.name = name
...
class BasicGUITester:
    ...
    def log_result(self, name: str, success: bool, message: str = "", error: Exception | None = None) -> TestResult:
        """Log a test result"""
    ...
    def test_navigation_utilities(self):
        ...
        try:
            ...
            from flet_server_gui.utils.simple_navigation import (
                SimpleNavigationState,
                create_simple_navigation_rail,
            )

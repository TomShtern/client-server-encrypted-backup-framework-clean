...
from Shared.app_logging.error_handler import (
    ErrorCategory,
    ErrorCode,
    ErrorSeverity,
    get_error_handler,
...
class TestProtocolFlexibility(unittest.TestCase):
    ...
    def test_version_range_support(self):
        ...
        from python_server.server.config import MAX_SUPPORTED_CLIENT_VERSION, MIN_SUPPORTED_CLIENT_VERSION
...
def run_all_tests():
    ...
    # Print summary
    print(f"\n{'='*60}")
    print("FIX VALIDATION TEST RESULTS")
    print(f"{'='*60}")

    ...
    page.add(
        ft.Container(
            content=ft.Column([
                ...
                ft.Row([
                    create_gradient_button("Primary", on_click=lambda _: None, gradient_type="primary", icon=ft.Icons.STAR),
                    create_gradient_button("Success", on_click=lambda _: None, gradient_type="success", icon=ft.Icons.CHECK),
                    create_gradient_button("Warning", on_click=lambda _: None, gradient_type="warning", icon=ft.Icons.WARNING),
                    create_gradient_button("Error", on_click=lambda _: None, gradient_type="error", icon=ft.Icons.ERROR)
                ...
                ft.Row([
                    create_metric_card_enhanced("Active Users", "1,234", "+12.5%", trend="up", icon=ft.Icons.PEOPLE, color_type="primary"),
                    create_metric_card_enhanced("Success Rate", "98.5%", "+2.1%", trend="up", icon=ft.Icons.CHECK, color_type="success"),
                    create_metric_card_enhanced("Warnings", "3", "-1", trend="down", icon=ft.Icons.WARNING, color_type="warning"),
                    create_metric_card_enhanced("Errors", "0", "-2", trend="down", icon=ft.Icons.ERROR, color_type="error")
                ], wrap=True, spacing=10),
                ...
                ft.Row([
                    create_modern_card(ft.Text("Modern Card\nNative Elevation", text_align=ft.TextAlign.CENTER), elevation=2),
                    create_modern_card(ft.Text("Elevated Card\nMaterial Design 3", text_align=ft.TextAlign.CENTER), elevation=4),
                    create_modern_card(ft.Text("High Elevation\nNative Shadows", text_align=ft.TextAlign.CENTER), elevation=8)
                ], wrap=True, spacing=10),
                ...
                # Test theme toggle
                ft.Container(
                    content=themed_button("Toggle Theme Mode", on_click=lambda _: toggle_theme_mode(page)),

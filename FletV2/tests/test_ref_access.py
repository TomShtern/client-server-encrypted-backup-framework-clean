...
def test_ref_access():
    ...
    try:
        # Test that the view creators can be imported without errors
        logger.info("✓ Dashboard view creator imports successfully")
        logger.info("✓ Clients view creator imports successfully")
        logger.info("✓ Files view creator imports successfully")

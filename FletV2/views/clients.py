...
def create_clients_view(server_bridge, page: ft.Page) -> ft.Control:
    ...
    # Create action handlers (simple functions) - LEGACY, keeping for compatibility
    ...
    def on_view_details_click(client_id):
        def handler(e):
            logger.info(f"View details for client {client_id}")
    ...
    # Initial table population - simple approach
    # Just populate with initial data, refs will be updated after page attach
    initial_clients = filter_clients()

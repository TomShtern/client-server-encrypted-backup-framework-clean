Title: Creating chat app in Python | Flet

URL Source: http://flet.dev/docs/tutorials/python-chat
...
*   [Create your first Flet app](http://flet.dev/docs/tutorials/python-chat#getting-started-with-flet)
*   [Add page controls and handle events](http://flet.dev/docs/tutorials/python-chat#adding-page-controls-and-handling-events)
*   [Broadcast messages using built-in PubSub library](http://flet.dev/docs/tutorials/python-chat#broadcasting-chat-messages)
*   [Use AlertDialog control for accepting user name](http://flet.dev/docs/tutorials/python-chat#user-name-dialog)
*   [Enhance user interface with reusable controls](http://flet.dev/docs/tutorials/python-chat#enhancing-user-interface)
*   [Deploy the app as a web app](http://flet.dev/docs/tutorials/python-chat#deploying-the-app)

The complete application will look like this:

![Image 1](https://flet.dev/img/docs/chat-tutorial/chat.gif)
...
Adding page controls and handling events[​](http://flet.dev/docs/tutorials/python-chat#adding-page-controls-and-handling-events "Direct link to Adding page controls and handling events")
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
![Image 3](https://flet.dev/img/docs/chat-tutorial/chat-layout-1.svg)
...
![Image 4](https://flet.dev/img/docs/chat-tutorial/chat-1.png)
...
![Image 5](https://flet.dev/img/docs/chat-tutorial/chat-2.gif)
...
![Image 6](https://flet.dev/img/docs/chat-tutorial/username-dialog.png)
...
![Image 7](https://flet.dev/img/docs/chat-tutorial/chat-4.png)
...
![Image 8](https://flet.dev/img/docs/chat-tutorial/chat-3.gif)
...
Before moving on to [deploying your app](http://flet.dev/docs/tutorials/python-chat#deploying-the-app), we suggest adding some extra features to it that will improve user experience and make the app look more professional.

### Reusable user controls[​](http://flet.dev/docs/tutorials/python-chat#reusable-user-controls "Direct link to Reusable user controls")

You may want to show messages in a different format, like this:

![Image 9](https://flet.dev/img/docs/chat-tutorial/chat-layout-chatmessage.svg)
...
### Laying out controls[​](http://flet.dev/docs/tutorials/python-chat#laying-out-controls "Direct link to Laying out controls")

Now you can use your brand new `ChatMessage` to build a better layout for the chat app:

![Image 10](https://flet.dev/img/docs/chat-tutorial/chat-layout-2.svg)
...
### Keyboard support[​](http://flet.dev/docs/tutorials/python-chat#keyboard-support "Direct link to Keyboard support")

#### Focusing input controls[​](http://flet.dev/docs/tutorials/python-chat#focusing-input-controls "Direct link to Focusing input controls")
...
#### Submitting forms on `Enter`[​](http://flet.dev/docs/tutorials/python-chat#submitting-forms-on-enter "Direct link to submitting-forms-on-enter")
...
#### Entering multiline messages[​](http://flet.dev/docs/tutorials/python-chat#entering-multiline-messages "Direct link to Entering multiline messages")
...
### Animated scrolling to the last message[​](http://flet.dev/docs/tutorials/python-chat#animated-scrolling-to-the-last-message "Direct link to Animated scrolling to the last message")
...
### Page title[​](http://flet.dev/docs/tutorials/python-chat#page-title "Direct link to Page title")

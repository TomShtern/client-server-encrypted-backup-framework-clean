Title: Creating Solitaire game with Python and Flet - Part 1 | Flet

URL Source: http://flet.dev/docs/tutorials/python-solitaire

Markdown Content:
In this tutorial we will show you step-by-step creation of a famous Klondike solitaire game in Python with Flet. For an inspiration, we looked at this online game: [https://www.solitr.com/](https://www.solitr.com/)
...
Here you can see the final result that you are going to achieve with Flet and this tutorial: [https://gallery.flet.dev/solitaire/](https://gallery.flet.dev/solitaire/)

![Image 1](https://flet.dev/img/docs/solitaire-tutorial/part1_final.gif)

We have broken down the game implementation into the following steps:

*   [Getting started with Flet](http://flet.dev/docs/tutorials/python-solitaire#getting-started-with-flet)
*   [Proof of concept app for draggable cards](http://flet.dev/docs/tutorials/python-solitaire#proof-of-concept-app-for-draggable-cards)
*   [Fanned card piles](http://flet.dev/docs/tutorials/python-solitaire#fanned-card-piles)
*   [Solitaire setup](http://flet.dev/docs/tutorials/python-solitaire#solitaire-setup)
*   [Solitaire rules](http://flet.dev/docs/tutorials/python-solitaire#solitaire-rules)
*   [Winning the game](http://flet.dev/docs/tutorials/python-solitaire#winning-the-game)
*   [Deploying the app](http://flet.dev/docs/tutorials/python-solitaire#deploying-the-app)
...
![Image 2](https://flet.dev/img/docs/tutorial/todo-app-hello-world.png)
...
### Step 1: Drag the card around[​](http://flet.dev/docs/tutorials/python-solitaire#step-1-drag-the-card-around "Direct link to Step 1: Drag the card around")
...
![Image 3](https://flet.dev/img/docs/solitaire-tutorial/drag_and_drop1.png)
...
![Image 4](https://flet.dev/img/docs/solitaire-tutorial/drag_and_drop2.gif)
...
### Step 2: Drop the card in the slot or bounce it back[​](http://flet.dev/docs/tutorials/python-solitaire#step-2-drop-the-card-in-the-slot-or-bounce-it-back "Direct link to Step 2: Drop the card in the slot or bounce it back")

The goal of this step is to be able to drop a card into a slot if it is close enough and bounce it back if it’s not.

![Image 5](https://flet.dev/img/docs/solitaire-tutorial/drag_and_drop3.gif)
...
### Step 3: Adding a second card[​](http://flet.dev/docs/tutorials/python-solitaire#step-3-adding-a-second-card "Direct link to Step 3: Adding a second card")
...
![Image 6](https://flet.dev/img/docs/solitaire-tutorial/drag_and_drop4.gif)
...
![Image 7](https://flet.dev/img/docs/solitaire-tutorial/drag_and_drop5.gif)
...
### Step 4: Adding more slots[​](http://flet.dev/docs/tutorials/python-solitaire#step-4-adding-more-slots "Direct link to Step 4: Adding more slots")
...
![Image 8](https://flet.dev/img/docs/solitaire-tutorial/drag_and_drop6.gif)
...
![Image 9](https://flet.dev/img/docs/solitaire-tutorial/fanned_piles3.gif)
...
### Slot, Card and Solitaire classes[​](http://flet.dev/docs/tutorials/python-solitaire#slot-card-and-solitaire-classes "Direct link to Slot, Card and Solitaire classes")
...
### Placing card with offset[​](http://flet.dev/docs/tutorials/python-solitaire#placing-card-with-offset "Direct link to Placing card with offset")
...
![Image 10](https://flet.dev/img/docs/solitaire-tutorial/fanned_piles1.png)

### Drag pile of cards[​](http://flet.dev/docs/tutorials/python-solitaire#drag-pile-of-cards "Direct link to Drag pile of cards")

If you try to drag the card from the bottom of the pile now, it will look like this:

![Image 11](https://flet.dev/img/docs/solitaire-tutorial/fanned_piles2.gif)
...
![Image 12](https://flet.dev/img/docs/solitaire-tutorial/game_setup_wiki.png)

We will now work on this setup step by step.

### Create card deck[​](http://flet.dev/docs/tutorials/python-solitaire#create-card-deck "Direct link to Create card deck")
...
### Create slots[​](http://flet.dev/docs/tutorials/python-solitaire#create-slots "Direct link to Create slots")

Klondike solitaire game layout should look like this:

![Image 13](https://flet.dev/img/docs/solitaire-tutorial/solitaire-layout.svg)
...
### Deal cards[​](http://flet.dev/docs/tutorials/python-solitaire#deal-cards "Direct link to Deal cards")
...
![Image 14](https://flet.dev/img/docs/solitaire-tutorial/game_setup1.png)
...
![Image 15](https://flet.dev/img/docs/solitaire-tutorial/game_setup2.png)
...
### Reveal top cards in tableau piles[​](http://flet.dev/docs/tutorials/python-solitaire#reveal-top-cards-in-tableau-piles "Direct link to Reveal top cards in tableau piles")
...
![Image 16](https://flet.dev/img/docs/solitaire-tutorial/game_setup3.png)
...
![Image 17](https://flet.dev/img/docs/solitaire-tutorial/game_rules1.gif)

Now it is time to implement some rules.

### General rules[​](http://flet.dev/docs/tutorials/python-solitaire#general-rules "Direct link to General rules")
...
![Image 18](https://flet.dev/img/docs/solitaire-tutorial/game_rules2.gif)

### Foundations rules[​](http://flet.dev/docs/tutorials/python-solitaire#foundations-rules "Direct link to Foundations rules")
...
### Tableau rules[​](http://flet.dev/docs/tutorials/python-solitaire#tableau-rules "Direct link to Tableau rules")
...
### Stock and waste[​](http://flet.dev/docs/tutorials/python-solitaire#stock-and-waste "Direct link to Stock and waste")
...
![Image 19](https://flet.dev/img/docs/solitaire-tutorial/winning_the_game.gif)

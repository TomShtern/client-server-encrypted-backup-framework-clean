Title: Making a Trello clone with Python and Flet | Flet

URL Source: http://flet.dev/docs/tutorials/trello-clone

Markdown Content:
Lets make a clone of Trello in Python with the Flet framework and then deploy it to [fly.io](https://fly.io/)!

![Image 1](https://flet.dev/img/docs/trolli-tutorial/trolli-app.gif)
...
![Image 2](https://flet.dev/img/docs/trolli-tutorial/mock-up.png)
...
![Image 3](https://flet.dev/img/docs/trolli-tutorial/basic-nav-rail-toggle.gif)
...
### Creating Views[​](http://flet.dev/docs/tutorials/trello-clone#creating-views "Direct link to Creating Views")
...
### Syncing Navigation Panel[​](http://flet.dev/docs/tutorials/trello-clone#syncing-navigation-panel "Direct link to Syncing Navigation Panel")
...
![Image 4](https://flet.dev/img/docs/trolli-tutorial/add-board-capability.gif)
...
### Routing[​](http://flet.dev/docs/tutorials/trello-clone#routing "Direct link to Routing")
...
![Image 5](https://flet.dev/img/docs/trolli-tutorial/navigation.gif)

### Changing Board Names[​](http://flet.dev/docs/tutorials/trello-clone#changing-board-names "Direct link to Changing Board Names")
...
![Image 6](https://flet.dev/img/docs/trolli-tutorial/drag-drop-list.gif)
...
![Image 7](https://flet.dev/img/docs/trolli-tutorial/drag-lists-and-items.gif)

Handling Page Resizing[​](http://flet.dev/docs/tutorials/trello-clone#handling-page-resizing "Direct link to Handling Page Resizing")
-------------------------------------------------------------------------------------------------------------------------------------

...
class ProcessMonitorWidget:
    ...
    def __init__(self, parent, title="Process Monitor", update_interval=2.0):
        self.parent = parent
        self.title = title
...
class ProcessMetricsChart:
    ...
    def __init__(self, parent, process_id: str, title="Process Metrics"):
        self.parent = parent
    ...
    def _create_widgets(self):
        ...
        chart_scrollbar = ttk.Scrollbar(chart_frame, orient="vertical", command=self.chart_text.yview)
    ...
    def _update_chart_data(self, metrics: ProcessMetrics):
...
def create_process_monitor_tab(notebook, title="Process Monitor"):

...
class CustomTheme:
    ...
    THEMES = {
        ...
        "Orange": {
            ...
            "secondary": "#FF8F00",
            "on_secondary": "#FFFFFF",
            "secondary_container": "#FFF3C4",
            "on_secondary_container": "#F57F17",
            "tertiary": "#FF5722",
            "on_tertiary": "#FFFFFF",
            "tertiary_container": "#FFCCBC",
            "on_tertiary_container": "#D84315",
            "error": "#BA1A1A",
            "on_error": "#FFFFFF",
            "error_container": "#FFDAD6",
            "on_error_container": "#410002",
            ...
            "background": "#1A1413",
            "on_background": "#EDE0DD"
        },
        "Teal": {
            "primary": "#00695C",
            "on_primary": "#FFFFFF",
            "primary_container": "#9ECCC1",
            "on_primary_container": "#00251A",
            "secondary": "#4A635E",
            "on_secondary": "#FFFFFF",
            "secondary_container": "#CCE8E1",
            "on_secondary_container": "#051F1C",
            "tertiary": "#456179",
            "on_tertiary": "#FFFFFF",
            "tertiary_container": "#CCE5FF",
            "on_tertiary_container": "#001E32",
            "error": "#BA1A1A",
            "on_error": "#FFFFFF",
            "error_container": "#FFDAD6",
            "on_error_container": "#410002",

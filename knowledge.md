...
This is **not** a typical web app. It is a **Hybrid Multi-Runtime System** that orchestrates a native C++ crypto-engine from a high-level Python management layer, visualized by a reactive Flet/Web UI.

...
def test_breakpoint_manager():
    ...
    from flet_server_gui.layout.responsive import BreakpointManager, Breakpoint
...
def test_responsive_builder():
    ...
    try:
        ...
        print(f"✅ Created adaptive container")
        ...
        print(f"✅ Calculated adaptive padding")
...
def test_layout_fixes():
    ...
    from flet_server_gui.layout.responsive import ResponsiveLayoutFixes, TouchTargetSpec, InteractionMethod
    import flet as ft
...
def test_enums_and_dataclasses():
    ...
    from flet_server_gui.layout.responsive import (
        ...
        DesktopBreakpoint, TouchTargetSpec
    )
...
def test_import_performance():
    ...
    try:
        ...
        from flet_server_gui.layout.responsive import (
            BreakpointManager, ResponsiveBuilder, ResponsiveLayoutFactory,
            ResponsiveLayoutFixes, Breakpoint, ScreenSize
        )
